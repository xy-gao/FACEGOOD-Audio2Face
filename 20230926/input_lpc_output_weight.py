...
if __name__ == "__main__":
    ...
    import os
    import numpy as np
    save_path = "./model_output/xuanyi_output.npy"
    pb_path = "./best_model/Audio2Face"
    pb_weights_animation = WeightsAnimation('./best_model/Audio2Face.tflite', pb_path)
    get_weight = pb_weights_animation.get_weight
    npy_path = "./lpc/xuanyi.npy"
    data = np.load(npy_path)
    weight_data = get_weight(data)
    np.save(save_path,weight_data)
